...
export const creditAccount = async (payload: TransactionInput, t:Transaction): Promise<TransactionOutput> => {
...
export const debitAccount = async (payload: TransactionInput, t:Transaction): Promise<TransactionOutput> => {
  const account = await Account.findOne({ where: { id: payload.account_id } });
 ...
 const tr = await transactionDal.create({
  ...
  console.log("trtrtrtrttrttrtrtrttrtt");
  console.log(tr);
  console.log("trtrtrtrttrttrtrtrttrtt");
